...
export class VisualizarFotosPage {
  ...
  clicar(foto){
    let comments = foto.payload.val();
    if(comments.comentarios === undefined){
      comments.comentarios = [];
    }
    comments.comentarios.push(this.comentario);
    this.fotosProvider.update(foto.payload.key, comments);
  }
